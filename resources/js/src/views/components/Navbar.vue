    ...
    <fwb-navbar sticky class="bg-slate-50">
        ...
        <template #default="{ isShowMenu }">
            <fwb-navbar-collapse :is-show-menu="isShowMenu">
                ...
                <router-link v-if="!authStore.isLoggedIn" class="font-bold tracking-wider pl-3 md:pl-0 py-1 md:py-0"
                    to="/login">
                ...
                <button
                    ...
                    v-else @click="logout">
                    <div class="pl-3 py-1 md:py-0 md:px-0 flex items-center justify-between gap-1">
                        <span>Keluar</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-8 md:size-6 pr-3 md:pr-0">
